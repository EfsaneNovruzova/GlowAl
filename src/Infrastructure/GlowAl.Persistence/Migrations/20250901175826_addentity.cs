    ...
    public partial class addentity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CareProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CareProducts_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CareProducts_SkinTypes_SkinTypeId",
                        column: x => x.SkinTypeId,
                        principalTable: "SkinTypes",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AIQueryHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AIQueryHistories_AspNetUsers_UserId1",
                        column: x => x.UserId1,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SkinProblemId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    SkinTypeId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Articles_CareProducts_ProductId",
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Articles_SkinTypes_SkinTypeId",
                        column: x => x.SkinTypeId,
                        principalTable: "SkinTypes",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductProblems", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reviews_CareProducts_ProductId",
                        column: x => x.ProductId,
                        principalTable: "CareProducts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AIQueryHistories_UserId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Articles_SkinProblemId",
                table: "Articles",
                column: "SkinProblemId");

            migrationBuilder.CreateIndex(
                name: "IX_Articles_SkinTypeId",
                table: "Articles",
                column: "SkinTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CareProducts_CategoryId",
                table: "CareProducts",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_CareProducts_SkinTypeId",
                table: "CareProducts",
                column: "SkinTypeId");
